 ...
 * - Contiene una `Column` con espaciado controlado por el Design System (`MVVMAppTheme.spacing`).
...
fun RegisterScreen(
    ...
    val s = MVVMAppTheme.spacing // Sistema de espaciado global (Design System)
