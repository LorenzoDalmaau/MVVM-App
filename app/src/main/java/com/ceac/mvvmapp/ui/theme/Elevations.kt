 ...
 * - Capa: **UI / Theme**
 * - Se integra con `MVVMAppTheme` para que esté disponible en toda la app.
 * - Acceso global mediante `MVVMAppThemeExt.elevations`.
 *
 * ----------------------------------------------------------------------------
 ...
 *         MVVMAppThemeExt.elevations.level2
 *     )
 * ) {
...
// 💡 Cómo usar en la app:
// -----------------------------------------------------------------------------
// MVVMAppThemeExt.elevations.level2 → obtiene el valor definido en el tema actual
//
